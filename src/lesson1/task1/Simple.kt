 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = (grad + min * 1.0 / 60 + sec * 1.0 / 3600) * PI / 180
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial * pow(1 + (percent * 1.0 / 100), 3.0)
